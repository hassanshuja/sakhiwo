    ...
    padding: 9px;">
            ...
            <div class="col">
                ...
                {!!  Form::select('district', $district, Input::old('district'), ['class' => 'form-control selectpicker', 'data-live-search' => "true" ,  'required' ]) !!}
                    ...
                    {!! Form::label('subdistrict', 'Sub Disctrict :', ['class' => 'col-lg-2 control-label']) !!}

                    <div class="col-lg-3">
                        {!!  Form::text('subdistrict', '', ['class' => 'form-control ',  'required' ]) !!}
                    </div>
                    <div class="col-lg-3">
                        ...
                        <tbody>
                         ...
                         @foreach ($datas as $index => $data)
                            ...
                            <tr data-id="{{$data->id}}">
                                ...
                                @if(\Auth::user()->hasRole('administrator'))
                                <td><a class="but btn btn-danger" href="{{route('admin.deletesubDistrict', [$data->id])}}">Delete</a></td>
                                 @endif
                            </tr>
                        @endforeach
                        @endif
...
$.ajaxSetup({
    ...
    var urls = '{{url('admin/editsubdistrict')}}' 
...
$.ajaxSetup({
    ...
    if(district == ''){
        alert('Error! Please Select District')
        return false;
    }
    if(subdistrict == ''){
    ...
    var data = {subdistrict: subdistrict, district: district};
    var urls = '{{url('admin/add_subdistrict')}}' 
