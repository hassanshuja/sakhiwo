...
<div class="row" style="margin-bottom:20px">
    ...
    padding: 9px;">
            <a href="{{ route('admin.registerForm') }}">
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-xs btn-danger user_destroy" href="{{ route('admin.users.destroy', [$user->id]) }}" data-toggle="tooltip" data-placement="top" data-title="{{ __('views.admin.users.index.delete') }}">
